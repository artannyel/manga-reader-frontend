...
void _chapterEntitySerialize(
  ...
  writer.writeStringList(offsets[5], object.localPagePaths);
  writer.writeString(offsets[6], object.mangaDexId);
  writer.writeString(offsets[7], object.mangaId);
  writer.writeLong(offsets[8], object.pagesCount);
  writer.writeDouble(offsets[9], object.readPercentage);
...
ChapterEntity _chapterEntityDeserialize(
  ...
  object.localPagePaths = reader.readStringList(offsets[5]);
  object.mangaDexId = reader.readString(offsets[6]);
  object.mangaId = reader.readString(offsets[7]);
  object.pagesCount = reader.readLong(offsets[8]);
  object.readPercentage = reader.readDouble(offsets[9]);
